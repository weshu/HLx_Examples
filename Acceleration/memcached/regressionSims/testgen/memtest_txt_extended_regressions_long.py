...
memlib.generate("SEQ1-EXTENDED_LONG", seq1(keys, values, 5))
memlib.generate_hls("SEQ1-EXTENDED_LONG", seq1(keys, values, 5))
memlib.generate("SEQ2-EXTENDED_LONG", seq2(keys, values))
memlib.generate_hls("SEQ2-EXTENDED_LONG", seq2(keys, values))
memlib.generate("SEQ3-EXTENDED_LONG", seq1(keys, values, 1))
memlib.generate_hls("SEQ3-EXTENDED_LONG", seq1(keys, values, 1))
