...
network_out_x_hls = "D00000000000000000000000000"
network_out_sop_hls = "D001ADB002020203719A0E0002050"
...
network_hls_any = "D0000000000000000000000000000"
...
def simulationInput(hexstream, empty=True):
	...
	if(len(words)==1):
		print >> sys.stderr, "WARNING: Adding invalid data line (workaround for kvs_tbDriver.vhdl bug)."
		l1 = "D0000000000000000000000000000" + "0000000000000000" + " 0\n" # workaround for buggy driver
		l2 =  network_sep + words[0] + EE
		input = l1 + l2
	elif(len(words)==2):
		l1 = network_sop + words[0] + AE
		l2 = network_eop + words[1] + EE
		input = l1 + l2
	else:
		words[0] = network_sop + words[0] + NE
		words[1:-2] = map(lambda s: network_any + s + NE, words[1:-2])
		words[-2] = network_any + words[-2] + AE
		words[-1] = network_eop + words[-1] + EE
		input = "".join(words)
...
def simulationOutput(hexstream):
	...
	if(len(words)==1):
		words[0] = network_out_x + "5" + mod_eop + words[0] + " 2\n"
	else:
		words[0] = network_out_sop + words[0] + " 2\n"
		words[1:-1] = map(lambda s: network_out_any + s + " 2\n", words[1:-1])
		words[-1] = network_out_x + "4" + mod_eop + words[-1] + " 2\n"
...
def simulationOutput_hls(hexstream):
	...
	if(len(words)==1):
		words[0] = network_hls + " " + words[0] + " " + '1' + " " + '1' + " " + '0'+ " " + '1' + "\n"
	else:
		words[0] = network_hls + " " + words[0] + " " + '1' + " " + '0' + " " + '0'+ " " + '1' + "\n"
		words[1:-1] = map(lambda s: network_hls_any_short + " " + s + " " + '0' + " " + '0' + " " + '0'+ " " + '1' + "\n", words[1:-1])
		words[-1] = network_hls_any_short + " " + words[-1] + " " + '0' + " " + '1' + " " + '0'+ " " + '1' + "\n"
...
def simulationOutput_rtl_hls(hexstream):
	...
	if(len(words)==1):
		...
		words[0] = network_out_sop_hls + words[0] + " 2\n"
